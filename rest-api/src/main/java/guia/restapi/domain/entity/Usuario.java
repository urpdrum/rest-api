package guia.restapi.domain.entity;

import guia.restapi.domain.entity.validation.EmailValidator;
import guia.restapi.domain.entity.validation.PasswordValidator;
